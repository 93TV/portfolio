...
<body>
    ...
    <ul>
        ...
        <li><?php echo htmlentities($item['Name']); ?>: <?php echo htmlentities($item['Via']); ?>: <?php echo htmlentities($item['Via']); ?> (<?php echo (new Datetime($item['added_on']))->format('d-m-Y H:i:s'); ?>)</li>
        <?php } ?>
    </ul>
    <?php
    } else {
